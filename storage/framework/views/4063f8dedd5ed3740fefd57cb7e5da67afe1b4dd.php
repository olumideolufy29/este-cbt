...
<form id="productForm" method="post" class="form-horizontal" action="<?php echo e(action('Admin\KelasController@store')); ?>">
    <?php echo csrf_field(); ?>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-6">
            <input type="text" class="form-control" name="name" placeholder="Masukkan Nama Kelas" value="<?php echo e(old('name')); ?>" required />
        </div>
    </div>
