...
<form id="productForm" method="post" class="form-horizontal" action="<?php echo e(action('Admin\TeacherController@update', $teacher->id)); ?>">
    <?php echo csrf_field(); ?>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-6">
            <input type="text" class="form-control" name="no_induk" placeholder="Masukkan Kode Siswa" value="<?php echo e(isset($teacher->user->no_induk) ? $teacher->user->no_induk : old('no_induk')); ?>" disabled />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-6">
            <input type="text" class="form-control" name="name" placeholder="Masukkan Nama Siswa" value="<?php echo e(isset($teacher->user->name) ? $teacher->user->name : old('name')); ?>" required />
        </div>
    </div>
