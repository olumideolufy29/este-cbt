 ...
 <div class="row">
        <div class="col-md-12">
          ...
          <tbody>
            ...
            <tr>
            <td align="center">
              <form action="<?php echo e(url('teacher/test-management/'.$test->id)); ?>" method="POST">
                  <?php echo csrf_field(); ?>

                  <?php echo method_field('DELETE'); ?>

                    <a href="<?php echo e(url('/teacher/test-management/'.$test->id.'/edit')); ?>" class="btn btn-default"><i class="glyphicon glyphicon-pencil"></i></a>
            ...
            <td align="center">            
              <form action="<?php echo e(url('teacher/question-management/'.$test->id)); ?>" method="POST">
                  <?php echo csrf_field(); ?>

                  <?php echo method_field('DELETE'); ?>

                    <a href="<?php echo e(url('/teacher/question-management/'.$test->id.'/edit')); ?>" class="btn btn-default"><i class="glyphicon glyphicon-pencil"></i></a>
                  <button type="submit" class="btn btn-danger">
                      <i class="glyphicon glyphicon-trash"></i>
                  </button>
              </form>        
