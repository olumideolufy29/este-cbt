...
<form id="productForm" method="post" class="form-horizontal" action="{{ action('Make\TestController@update', $test->id) }}">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-7">
            <input type="text" class="form-control" name="code_test" value="{{ $test->code or old('code_test') }}"  placeholder="Masukkan Kode Test" disabled/>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-7">
            <input type="text" class="form-control" name="name_test" placeholder="Masukkan Nama Test" required value="{{ $test->name or old('name') }}" />
        </div>
    </div>
